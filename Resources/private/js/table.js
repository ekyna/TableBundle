(function(root, factory) {
    ...
    EkynaTable.prototype = {
        ...
        init: function () {
            ...
            var t = this;
            this.$elem.on('click', '.table-select-toggle', function (e) {
                t.$elem.find('tbody .selector input').prop('checked', $(this).prop('checked'));
            });
            ...
            // Prevents the config dropup from closing when inner elements are clicked
            this.$elem.on('click', '.table-config .dropdown-menu', function(e) {
                e.stopPropagation();
            });
